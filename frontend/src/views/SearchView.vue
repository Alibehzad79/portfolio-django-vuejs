<template>
    <div class="project-view container p-5">
        <div class="mt-5 d-flex flex-column m-auto gap-2">
            ...
            <div v-if="data == null" class="border p-5 border-dark rounded m-auto">
                <span class="d-flex align-items-center gap-2"><i class="ri-box-3-line fs-1"></i> Empty</span>
            </div>
            <div v-if="data == ''" class="border p-5 border-dark rounded m-auto">
                <span class="d-flex align-items-center gap-2"><i class="ri-box-3-line fs-1"></i> Article Not Found!</span>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        axios.get(`${this.domain}/api/v1/blog/articles/?search=${this.$route.params.search}`)
